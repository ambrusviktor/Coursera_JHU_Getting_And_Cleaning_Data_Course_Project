...
setwd("D:\\OneDrive - Debreceni Egyetem/coursera/Johns_Hopkins_Data_Science/Getting_and_Cleaning_Data/Course_Project_AV/")
...
# Reading in the features and activities
